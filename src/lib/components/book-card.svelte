...
<a href={`/book/${slugify(name)}`} class="cursor-pointer flex flex-col items-center px-5 py-2 w-full max-w-xs" draggable="false">
	<ThreeDBook {image} {name} hoverEffect />

	<!-- Product Info -->
	<div class="space-y-1 text-center w-full">
		<h3 class="text-sm sm:text-base font-medium text-foreground break-words line-clamp-2">
		...
		<p class="text-xs sm:text-sm text-muted-foreground break-words line-clamp-2">
